...
(
	DATE_TIME DATETIME PRIMARY KEY, -- ngày comment
	ID_REST INT NOT NULL,
	EMAIL_USER VARCHAR(30) NULL, -- người dùng bình thường
	USERNAME_RESTAURANT VARCHAR(20) NULL, -- là chủ quán ăn comment
...
ALTER TABLE FOODS ADD CONSTRAINT FK_FOODS_RESTAURANT FOREIGN KEY(ID_REST) REFERENCES RESTAURANT(ID);

ALTER TABLE FOODS ADD CONSTRAINT FK_FOODS_CATALOGS FOREIGN KEY(ID_CATALOG) REFERENCES CATALOGS(ID);
...
ALTER TABLE COMMENTS ADD CONSTRAINT FK_COMMENTS_GUESTACCOUNT FOREIGN KEY(EMAIL_USER) REFERENCES GUESTACCOUNT(EMAIL);


ALTER TABLE COMMENTS ADD CONSTRAINT FK_COMMENTS_ACCOUNT FOREIGN KEY(USERNAME_RESTAURANT) REFERENCES ACCOUNT(EMAIL);
