...
(
	DATE_TIME DATE PRIMARY KEY, -- ngày comment
	ID_REST INT NOT NULL,
...
ALTER TABLE dbo.FOODS ADD CONSTRAINT FK_FOODS_RESTAURANT FOREIGN KEY(ID_REST) REFERENCES dbo.RESTAURANT(ID)
GO
...
ALTER TABLE dbo.COMMENTS ADD CONSTRAINT FK_COMMENTS_ACCOUNT FOREIGN KEY(USERNAME_RESTAURANT) REFERENCES dbo.ACCOUNT(EMAIL)
GO
